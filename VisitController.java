...
class VisitController {
	...
	public VisitController(OwnerRepository owners, PetRepository pets) {
		this.owners = owners;
		this.pets = pets;
	}
	...
	public Visit loadPetWithVisit(@PathVariable("ownerId") int ownerId, @PathVariable("petId") int petId,
		...
		if (optionalPet.isEmpty()) {
			throw new ResponseStatusException(HttpStatus.NOT_FOUND, "Pet not found with id: " + petId + " for owner with id: " + ownerId);
		}

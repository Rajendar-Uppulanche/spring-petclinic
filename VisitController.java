...
class VisitController {
	...
	public String processNewVisitForm(@ModelAttribute Owner owner, @PathVariable int petId, @Valid Visit visit,
		...
		if (visit.getDate() != null && visit.getDate().isAfter(LocalDate.now())) {
			result.rejectValue("date", "future.visitDate", "Visit date cannot be in the future.");
		}
	...
	public String initUpdateVisitForm(@PathVariable("visitId") int visitId, Map<String, Object> model) {
	...
	public String processUpdateVisitForm(@Valid Visit visit, BindingResult result,
			@PathVariable("ownerId") int ownerId, @PathVariable("petId") int petId, @PathVariable("visitId") int visitId,
		...
		redirectAttributes.addFlashAttribute("message", "Visit details updated successfully.");

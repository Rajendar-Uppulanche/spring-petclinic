...
class VisitController {
	...
	public VisitController(OwnerRepository owners, VisitService visitService,
			VisitTypeRepository visitTypeRepository, VeterinarianRepository veterinarianRepository) {
		this.owners = owners;
	...
	public String initUpdateVisitForm(@PathVariable int visitId, Model model) {
	...
	public String processUpdateVisitForm(@Valid Visit visit, BindingResult result,
		...
		Visit existingVisit = this.visitService.findById(visit.getId());
		existingVisit.setDescription(visit.getDescription());
		// Visit date and type are immutable

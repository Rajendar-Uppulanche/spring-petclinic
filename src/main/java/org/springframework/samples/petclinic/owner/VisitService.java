...
public class VisitService {
	...
	@Autowired
	public VisitService(VisitRepository visitRepository, OwnerRepository ownerRepository, PetRepository petRepository, VetRepository vetRepository) {
	...
	// NFR-009: Calculate duration in minutes
	public String calculateDuration(Visit visit) {
		if (visit.getCheckInTime() == null || visit.getCheckOutTime() == null) {
			return "In Progress"; // BR-015
		}

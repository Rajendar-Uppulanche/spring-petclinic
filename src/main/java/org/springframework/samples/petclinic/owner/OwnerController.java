...
class OwnerController {
	...
	public String processCreationForm(@Valid Owner owner, BindingResult result, RedirectAttributes redirectAttributes) {
		if (result.hasErrors()) {
			...
			redirectAttributes.addFlashAttribute("message", "Owner has been created");
	...
	public String processUpdateOwnerForm(@Valid Owner owner, BindingResult result,
		...
		if (result.hasErrors()) {
			...
			owner.setId(ownerId);
			this.owners.save(owner);
			redirectAttributes.addFlashAttribute("message", "Owner has been updated");
	...
	public String showOwner(@PathVariable("ownerId") int ownerId, Map<String, Object> model) {
		...
		owner.getPets().forEach(pet -> pet.setVisitCount(pet.getVisits().size())); // Populate visit counts
		model.put("owner", owner);

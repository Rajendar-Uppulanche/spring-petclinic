...
public interface VisitRepository extends JpaRepository<Visit, Integer> {
    ...
    @Query("SELECT v FROM Visit v WHERE " +
           ...
           "(:descriptionKeyword IS NULL OR LOWER(v.description) LIKE LOWER(CONCAT('%', :descriptionKeyword, '%')))")
    ...
    List<Visit> findByVeterinarianId(Integer veterinarianId);
    List<Visit> findByPetOwnerId(Integer ownerId);
}
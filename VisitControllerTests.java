...
import org.springframework.boot.webmvc.test.context.MockReset;
 ...
 * @author Wick Dynex
 */
@WebMvcTest(value = VisitController.class, includeFilters = @ComponentScan.Filter(type = FilterType.ASSIGNABLE_TYPE, classes = VetController.class))
...
class VisitControllerTests {
	...
	void processEditVisitFormSuccess() throws Exception {
		mockMvc
			...
			.andExpect(status().is3xxRedirection())
			.andExpect(view().name("redirect:/owners/{ownerId}/pets/{petId}/visits/{visitId}"));
	}
